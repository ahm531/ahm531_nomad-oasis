![docker image](https://github.com/ahm531/ahm531_nomad-oasis/actions/workflows/docker-publish.yml/badge.svg)


# ahm531's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of ahm531.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/ahm531/ahm531_nomad-oasis.git
    cd ahm531_nomad-oasis
    ```

    or

    ```sh
    curl-L -o ahm531_nomad-oasis.zip "https://github.com/ahm531/ahm531_nomad-oasis/archive/main.zip"
    unzip ahm531_nomad-oasis.zip
    cd ahm531_nomad-oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/ahm531/ahm531_nomad-oasis:main` for the services
...
```sh
docker pull ghcr.io/ahm531/ahm531_nomad-oasis/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/ahm531/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/ahm531/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/ahm531/ahm531_nomad-oasis/manifests/main": unauthorized`
